...
def parse_args():
    ...
    parser.add_argument('--datasetType', default='ImageNet', type=str, help='cifar100, cifar10, dataset to use')
    ...
    parser.add_argument('--model', default='axial26s', help='Model names.')
    ...
    parser.add_argument('--name', default='qaxial26s', help='the name of work_dir')
